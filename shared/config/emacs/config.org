...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Ólafur Bjarki Bogason"
    user-mail-address "olafur@genkiinstruments.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/olafur/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/olafur/bin" "/profile/bin" "/Users/olafur/.npm-packages/bin" "/Users/olafur/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
